    ...
    def test_returns_skill_candidates(self):
        ...
        skills = [
            ...
            Skill(
                ...
                conditions=Conditions(triggers=["Text processing"]),
    ...
    def test_original_extractor_still_works(self):
        ...
        skills = [
            Skill(
                ...
                conditions=Conditions(triggers=["Formatting"]),
    ...
    def test_scan_assembled_skill(self):
        ...
        skill = Skill(
            ...
            conditions=Conditions(
                triggers=["User requests safe text processing operation"],
...
class TestG2RoundTrip:
    ...
    def test_g2_score_round_trip(self):
        ...
        skill = Skill(
            ...
            conditions=Conditions(
                triggers=["User requests G2 score verification"],
