    ...
    def test_extract_returns_candidates(self):
        skills = [
            ...
            Skill(
                ...
                conditions=Conditions(trigger="Text processing needed"),
...
class TestAssemble:
    ...
    def test_assemble_creates_output(self):
        skill = Skill(
            ...
            conditions=Conditions(
                trigger="User requests text formatting with specific style and formatting preferences",
    ...
    def test_skill_md_is_valid_markdown(self):
        skill = Skill(
            ...
            conditions=Conditions(
                trigger="User requests code formatting with specific style preferences",
                preconditions=["Python files exist in workspace", "black formatter installed"],
    ...
    def test_skill_yaml_is_valid_yaml(self):
        skill = Skill(
            ...
            conditions=Conditions(
                trigger="User requests the test operation with required parameters",
